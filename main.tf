...
resource "aws_cloudwatch_log_resource_policy" "es-log-policy" {
  policy_name = "global-es-log-policy"
...
### "Global Analytics Connector's Admin specific internal secret. This will be created By admins Manually and Updated by  Terraform Code after the Elasticsearch domain Provisioning completed."
