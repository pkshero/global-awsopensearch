...
variable "tags" {
  ...
  type        = map(string)
  default = {
    Application     = "Global Analytics Connector with OpenSearch"
    Developer       = "Global"
    PublicationType = "Global Labs"
    Version         = "V 0.1"
  }
}
...
variable "domain_prefix" {
  description = "String to be prefixed to search domain. Default: global-labs-"
  type        = string
  default     = "global-labs-"
}
